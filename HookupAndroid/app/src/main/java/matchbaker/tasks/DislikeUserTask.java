 ...
 */
public class DislikeUserTask extends AsyncTask<String, String, String> {


    public DislikeUserTask() {
    }
    ...
    protected String doInBackground(String... params) {
        ...
        Request request = new Request.Builder()
                .url(Constants.SERVER_URL + "/firebaseUser/" + currentUser.getUid() + "/dislike/" + params[0])
                .post(body)
                .build();
