...
import matchbaker.tasks.UpdateUserLocationTask;
...
//    @BindView(R.id.home_recommended_persons_count_text) TextView recommendedPersonsCountText;
    ...
    @BindView(R.id.hookup_recommendations_counter_text) TextView hookupRecommendationCounterText;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(currentUser != null && !currentUser.isProfileComplete()) {
            ...
            if(currentUser.getUnpairedRecommendationsCounter() > 0 ) {
                ...
                nearestHookupDistanceText.setText(getString(R.string.nearest_recommended_text) + " " + Double.toString(currentUser.getNearestHookupDistnace()) + " km");
                hookupRecommendationCounterText.setText(Integer.toString(currentUser.getUnpairedRecommendationsCounter()) + " " + getString(R.string.hookup_recommendations_counter_text));
            }
        }
