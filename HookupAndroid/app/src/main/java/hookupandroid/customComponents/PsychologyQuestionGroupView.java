...
public class PsychologyQuestionGroupView extends LinearLayout implements HundredScaleSeekbarLayout.HundredScaleSeekbarInteractionListener {
    ...
    @BindView(R.id.shared_interests_seek_bar) HundredScaleSeekbarLayout sharSeekbar;

    public PsychologyQuestionGroupView(Context context) {
        super(context);
    }

    public PsychologyQuestionGroupView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
